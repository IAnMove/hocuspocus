...
class TestModelSelectionPersistence(unittest.TestCase):
    ...
    def test_story_lab_video_format_is_selectable_and_reopenable(self):
        ...
        self.assertIn("setDirectorResolution(options.generationSettings.resolution)", story)
        self.assertIn("setDirectorAspectRatio(options.generationSettings.aspectRatio)", story)
    ...
    def test_story_video_override_is_durable_local_and_explicitly_handed_to_director(self):
        ...
        self.assertIn("await store.selectDirectorVideoModel(videoModel)", story)
        self.assertIn("selectDirectorModels(\n    generationSettings.videoModel", story)
