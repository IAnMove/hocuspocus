...
def _check_triton():
    ...
    from shared.wangp1300.kernels.triton_compilation_log import install_triton_compilation_logger
...
class NanoVllmTextEngine:
    ...
    def _ensure_llm(self):
        ...
        try:
            ...
            pass
        try:
            from shared.wangp1300.llm_engines.nanovllm import LLM, SamplingParams
