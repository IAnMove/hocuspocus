...
class Qwen3_5StaticCache(Qwen3_5DynamicCache):
    ...
    def snapshot(self, previous: dict | None = None, reuse_tokens: int = 0) -> dict:
        from shared.wangp1300.llm_engines.snapshot_cache import snapshot_cache
    ...
    def restore(self, snapshot: dict) -> None:
        from shared.wangp1300.llm_engines.snapshot_cache import restore_cache
...
class Qwen3_5Block(nn.Module):
    ...
    def _forward_linear_attention(
        ...
        if speculative_verify and use_short_convolution and is_cuda:
            from shared.wangp1300.llm_engines.nanovllm.layers.speculative_state import conv_verify
        ...
        if speculative_verify and self._fast_recurrent_gated_delta_rule is not None and is_cuda:
            from shared.wangp1300.llm_engines.nanovllm.layers.speculative_state import recurrent_verify
