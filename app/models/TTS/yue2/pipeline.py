...
from shared.wangp1300.llm_engines.nanovllm.token_generation import TokenGenerationEngine
...
class YuE2Pipeline:
    ...
    def generate(self, input_prompt, alt_prompt, seed, duration_seconds, sampling_steps, guide_scale, temperature, top_k, top_p, model_mode=0, custom_settings=None, VAE_tile_size=1024, callback=None, audio_prompt_type="", audio_guide=None, offloadobj=None, input_custom=None, **kwargs):
        ...
        if audio_prompt_type or audio_guide or input_custom or custom_settings:
            raise ValueError("YuE2 supports lyrics/style generation; source audio and scores are not supported by this adapter.")
        abc = ""
