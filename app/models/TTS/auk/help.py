...
Use named emotions; vague "hilarious" was rewritten to `happy` by Refine in testing, not laughter or comic delivery. Inspect the refined instruction. There is no automatic stop after the requested words: too much duration can produce repetition or invented speech; too little can cut words off. The 5-second default may still be too long for shorter TTS/cloning requests.
