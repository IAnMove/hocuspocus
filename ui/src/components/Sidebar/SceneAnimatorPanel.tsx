    ...
    <aside className="w-full shrink-0 border-t border-border bg-bg-secondary p-3 overflow-y-auto space-y-3 xl:w-[300px] xl:border-l xl:border-t-0">
      ...
      <div className="space-y-1.5 rounded border border-emerald-400/30 bg-emerald-400/[.04] p-2">
        ...
        {characterKitDraft && <div className="space-y-1.5 rounded border border-emerald-300/20 bg-black/10 p-1.5">
          ...
          <div className="grid grid-cols-2 gap-1"><button type="button" onClick={() => setCharacterKitEditorTab('kit')} className={`rounded border px-1 py-1 text-[8px] ${characterKitEditorTab === 'kit' ? 'border-emerald-300 bg-emerald-400/10 text-emerald-100' : 'border-border text-text-muted'}`}>Kit & poses</button><button type="button" onClick={() => setCharacterKitEditorTab('face-rig')} className={`rounded border px-1 py-1 text-[8px] ${characterKitEditorTab === 'face-rig' ? 'border-emerald-300 bg-emerald-400/10 text-emerald-100' : 'border-border text-text-muted'}`}>Face Rig</button></div>
