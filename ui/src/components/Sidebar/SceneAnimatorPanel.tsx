...
type Preset = { id: string; label: string; start: Point; end: Point; duration: number; spin: boolean; curve: SceneCurve; requiresTarget?: boolean; preview?: string }
...
const PRESETS: Preset[] = [
  ...
  { id: 'orbit-layer', label: 'Orbit around another layer', start: makePoint(50, 50, .45), end: makePoint(50, 50, .45), duration: 5, spin: true, curve: 'linear', requiresTarget: true, preview: '/preset-previews/orbit-layer-preview.webm' } as Preset,
])
