      ...
      <SectionCard title="Providers and render canvas" description="Series keeps its own saved defaults; a job records the exact effective values.">
        ...
        <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-3">
          <SeriesField label="Writing provider"><select className={selectClass} value={series.provider.writingProvider} onChange={event => patchProvider({ writingProvider: event.target.value as SeriesProject['provider']['writingProvider'] })}>
            <option value="maestro">Loreframe Lab local</option><option value="deepseek">DeepSeek</option><option value="minimax">MiniMax</option><option value="openai">OpenAI</option><option value="openai-compatible">Compatible</option>
          </select></SeriesField>
          ...
          <SeriesField label="Image provider"><select className={selectClass} value={series.provider.imageProvider} onChange={event => patchProvider({ imageProvider: event.target.value })}><option value="maestro">Loreframe Lab local · explicit model</option><option value="minimax">MiniMax Image API</option></select></SeriesField>
