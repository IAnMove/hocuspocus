...
export const INDEX = {
  ...
  tulip: 170,
  neon: 176,
  wave: 180, waveSteps: 8,
  flame: 188, flameSteps: 4,
  room: 192, drop: 200, dropSteps: 8,
  umbra: 208,
  leaf: 210, snowFar: 214, snowNear: 218,
  glass: 222, glassSteps: 6,
  pad: 228, pond: 231,
  grid: 234,
  crystal: 236, crystalSteps: 8,
  swirl: 244, halo: 252,
  // Neon lettering: five letters and a VACANCY line, in a free run of slots.
  sign: 164,
} as const
