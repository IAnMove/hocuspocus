...
export function Scene3DTemplateBrowser({ selected, disabled, onSelect }: {
  ...
  return <section className="rounded-xl border border-border bg-bg-secondary p-3" aria-label={t('templates')}>
    <div className="flex flex-wrap items-center justify-between gap-3">
      ...
      <a href="/examples/kingdom-road/" target="_blank" rel="noopener noreferrer" className="min-h-10 rounded-lg border border-cyan-300/40 px-3 py-2 text-sm text-cyan-200">{t('kingdomRoadReview')}</a>
