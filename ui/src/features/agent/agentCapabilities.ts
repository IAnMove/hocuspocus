...
export const AGENT_CAPABILITIES: AgentCapabilityDescriptor[] = [
  ...
  },
  {
    ...
    title: 'Attach Character Kit references',
    purpose: 'Attach existing image outputs as the kit identity reference.',
    useWhen: 'The user asks to use generated images as the character reference.',
    risk: 'edit',
  ...
  },
  {
    ...
    purpose: 'Open the Video Editor draft, optionally renaming the project.',
    useWhen: 'The user asks to open Video Editor or a named editor project.',
    risk: 'read',
